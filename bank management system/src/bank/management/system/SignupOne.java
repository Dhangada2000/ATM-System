...
public class SignupOne extends JFrame implements ActionListener {
    ...
    SignupOne() {
        ...
        nameTextField.setFont(new Font("Taieway", Font.BOLD, 14));
        ...
        fnameTextField.setFont(new Font("Taieway", Font.BOLD, 14));
        ...
        emailTextField.setFont(new Font("Taieway", Font.BOLD, 14));
        ...
        addressTextField.setFont(new Font("Taieway", Font.BOLD, 14));
        ...
        cityTextField.setFont(new Font("Taieway", Font.BOLD, 14));
        ...
        stateTextField.setFont(new Font("Taieway", Font.BOLD, 14));
        ...
        pinTextField.setFont(new Font("Taieway", Font.BOLD, 14));
    ...
    public void actionPerformed(ActionEvent ae) {
        String formno= "" + random; // convert long into string using "" +
